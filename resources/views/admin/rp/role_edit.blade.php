...
<div class="container-fluid px-4">
    ...
    <form method="POST" action="{{route('admin.rp.role.update',$role->id)}}">
    	@csrf
    	@method('PUT')
	  <div class="mb-3">
	    <label for="roleName" class="form-label">Role Name</label>
	    <input type="text" name="name" value="{{$role->name}}" class="form-control" id="roleName" aria-describedby="roleHelp">
